function [ sentences ,init_sents,split_conditions] = sentenceSplitter( textfile )
...
%
% 1. Initially splits the text into sentences based on punctuation
%    delimiters and selected greek abbreviation with letter length > 1.
%
...
%
% Note : Only length > 1 words between '.' abbreviations (e.g {εκατ. , δισεκατ. }) should be added,
...
sentence_ending_punctuations = {'.','·','!',';','*','...'}; % Grammaticaly common sentence ending punctuations
